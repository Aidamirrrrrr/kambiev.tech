...
export const en: Dictionary = {
  ...
  ctaBanner: {
    ...
    text: "Open to job offers and to project work: product development, architecture, getting a project to production.",
    cta: "Get in touch",
    ctaTelegram: "Message on Telegram",
    meta: "Saint Petersburg or remote · Russian and English",
  },
  contact: {
    label: "Get in touch",
    title: "Tell me about",
    ...
    sentText:
      "The message is already in my Telegram. If you need me sooner, write there directly.",
